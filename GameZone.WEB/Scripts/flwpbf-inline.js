...
//document.addEventListener("DOMContentLoaded", function(event) { 
    ...
    function loadIframe (data) { 
    	...
    	getpaidiframe.setAttribute('style', 'position:fixed; top:0; left:0; z-index:9999; border:none;');
    ...
    window.getpaidSetup = function (config) {
        ...
        if(config.hosted_payment == 1 && !config.is_hosted_page){
            ...
            form.setAttribute('action', 'https://api.ravepay.co/flwv3-pug/getpaidx/api/hosted/pay');
            for(var c in config){
